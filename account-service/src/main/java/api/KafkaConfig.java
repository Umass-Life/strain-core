...
public class KafkaConfig {
    public static Logger log = Logger.getLogger(KafkaConfig.class.getName());
...
//        Listener listener = new Listener("Kappa123");
...
//    }
    ...
    public static class Listener {
        ...
        public Listener(String name){
            this.name = name;
            log.info("\n---> Listener initialized " + name);
        }
//        @KafkaListener(id = GROUP_ID_CONFIG , topics = "new-strain-user")//"#{'${spring.kafka.topics.new-strain-user}'}" )
//        @SendTo
